...
root = Path("..")
expert_path = root / "outputs" / "trajectories_expert_trec_dl_combined_50.csv"
cql_path    = root / "outputs" / "cql_test_results_trec_dl_combined_50.csv"
...
plt.tight_layout()
plt.savefig(r"..\outputs\cql_vs_expert_trec_dl_combined_reward_scatter.png", dpi=150)
print("Saved plot: outputs/cql_vs_expert_trec_dl_combined_reward_scatter.png")

paired.to_csv(r"..\outputs\cql_vs_expert_trec_dl_combined_per_query.csv", index=False)
print("Saved per-query CSV: outputs/cql_vs_expert_trec_dl_combined_per_query.csv")
